...
> 2026-09-19 the display chain is verified on hardware — an SSD1306 module at 7-bit
> `0x3C` lighting every pixel, with the MAIN menu rendered centred — while every other
> page, every button and every analog input is still pending. Read
